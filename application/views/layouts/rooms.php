        ...
        <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
            ...
            <div>
                ...
                <div class="text-center p-4 border-bottom">
                    ...
                    <p class="text-muted text-truncate mb-1"><i class="ri-record-circle-fill font-size-10 text-success me-1 ms-0 d-inline-block"></i>
                        Active</p>
                </div>
                <!-- End profile user -->
                    ...
                    <div class="chat-message-list px-2" data-simplebar>
                        ...
                        <ul class="list-unstyled chat-list chat-user-list">
                            <?php foreach ($rooms as $room) : ?>
                                <li>
                                    <a href="#" data-href="<?= base_url('app/room/' . $room['roomID']) ?>">
                                        <div class="d-flex">
                                            <div class="chat-user-img online align-self-center me-3 ms-0">
                                                <img src="https://flagsapi.com/<?= $room['roomLang'] ?>/flat/64.png" class="rounded-circle avatar-xs" alt="">
                                                <span class="user-status"></span>
                                            </div>

                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="text-truncate font-size-15 mb-1"><?= $room['roomTitle'] ?></h5>
                                                <p class="chat-user-message text-truncate mb-0">#sanat</p>
                                            </div>
                        ...
                        <li>
                            <a href="#">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="text-truncate font-size-14 mb-0">#Reporting <span class="badge badge-soft-danger rounded-pill float-end">+23</span>
                                        </h5>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="text-truncate font-size-14 mb-0">#Developers <span class="badge badge-soft-danger rounded-pill float-end">New</span>
                                        </h5>
                                    </div>
                                </div>
